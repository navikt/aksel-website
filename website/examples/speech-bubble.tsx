...
SpeechBubbleExample.react = `<SpeechBubble illustration="OLA" topText="Ola Normann 01.01.21 14:00">
<SpeechBubble.Bubble>
  Aute minim nisi sunt mollit duis sunt nulla minim non proident.
</SpeechBubble.Bubble>
<SpeechBubble.Bubble>
...
export const SpeechBubblePosisjonering = () => (
  <div>
    ...
    <SpeechBubble illustration="PER" position="right">
      <SpeechBubble.Bubble>Ipsum laborum culpa ea</SpeechBubble.Bubble>
      <SpeechBubble.Bubble>
        Adipisicing deserunt mollit ea cillum nulla sunt
      </SpeechBubble.Bubble>
    </SpeechBubble>
  </div>
);

SpeechBubblePosisjonering.react = `<SpeechBubble illustration="OLA" position="left">
<SpeechBubble.Bubble>
  Aute minim nisi sunt mollit duis sunt nulla minim non proident.
</SpeechBubble.Bubble>
</SpeechBubble>
...
SpeechBubbleIllustrasjon.react = `<SpeechBubble illustration={<Illustration />} position="left">
<SpeechBubble.Bubble>
  Aute minim nisi sunt mollit duis sunt nulla minim non proident.
</SpeechBubble.Bubble>
</SpeechBubble>`;
